...
export default function MarketingRequestChat() {
  const { agent } = useAuth()
  ...
  return (
    <div>
      <h3 style={{ fontSize: '1rem' }}>{agent?.role === 'Marketing' ? 'Request material' : 'Requests from Marketing'}</h3>
      <p style={{ color: 'var(--color-secondary)', fontSize: '0.88rem', marginBottom: 16 }}>
